...
class MoveitMoveCartesian(EventState):
    ...
    -- move                 Wether or not the arm should move or simply check if the move is possible
    ...
    def on_enter(self, userdata):
	    ...
	    waypoints = []
	    waypoints.append(group.get_current_pose().pose) #Adds the current position
	    waypoints.append(copy.deepcopy(userdata.targetPose)) #Adds the targetposition
            try:
