...
class Action_pickSM(Behavior):
    ...
    def create(self):
        # x:924 y:533, x:407 y:277, x:525 y:464, x:425 y:124, x:527 y:322, x:1085 y:581
        ...
        with _state_machine:
            ...
            OperatableStateMachine.add('open gripper',
                                        ...
                                        transitions={'object': 'get_pose', 'no_object': 'get_pose'},
            ...
            OperatableStateMachine.add('Check_reachability',
                                        ...
                                        transitions={'ok': 'PreGripPose', 'too_far': 'too far s'},
