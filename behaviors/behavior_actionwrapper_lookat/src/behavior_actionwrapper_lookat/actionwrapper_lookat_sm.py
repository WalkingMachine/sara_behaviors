...
class ActionWrapper_LookAtSM(Behavior):
	...
	def create(self):
		# x:1213 y:438, x:130 y:365, x:230 y:365
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Entity',
										...
										transitions={'found': 'GetPosition', 'none_found': 'Look for object'},
			...
			OperatableStateMachine.add('look for',
										list_entities_by_name(frontality_level=0.5, distance_max=10),
										transitions={'found': 'GetPosition', 'none_found': 'Look the other side'},
										autonomy={'found': Autonomy.Off, 'none_found': Autonomy.Off},
										remapping={'name': 'name', 'entity_list': 'entity_list', 'number': 'number'})
			...
			OperatableStateMachine.add('look again',
										list_entities_by_name(frontality_level=0.5, distance_max=10),
										transitions={'found': 'GetPosition', 'none_found': 'not found'},
										autonomy={'found': Autonomy.Off, 'none_found': Autonomy.Off},
										remapping={'name': 'name', 'entity_list': 'entity_list', 'number': 'number'})
