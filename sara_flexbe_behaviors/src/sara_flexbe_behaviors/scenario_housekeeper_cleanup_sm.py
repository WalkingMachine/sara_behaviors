...
( "___" : TO COMPLETE )
	...
	def __init__(self):
		...
		self.add_behavior(sara_flexbe_behaviors__Action_MoveSM, 'Goto__WhileLooking/Action_Move')
		self.add_behavior(sara_flexbe_behaviors__Action_placeSM, 'PutDownObject/Action_place')
	...
	def create(self):
		...
		with _sm_putdownobject_5:
			...
			OperatableStateMachine.add('Action_place',
										self.use_behavior(sara_flexbe_behaviors__Action_placeSM, 'PutDownObject/Action_place'),
		...
		with _sm_goto__whilelooking_9:
			...
			OperatableStateMachine.add('Action_Move',
										self.use_behavior(sara_flexbe_behaviors__Action_MoveSM, 'Goto__WhileLooking/Action_Move'),
										transitions={'finished': 'done', 'failed': 'failed'},
										autonomy={'finished': Autonomy.Inherit, 'failed': Autonomy.Inherit},
